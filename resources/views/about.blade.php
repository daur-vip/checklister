...
@section('content')
    ...
    <section class="slider slider-about">
        ...
        <div class="slider-content slider-content--about">
            ...
            <div class="slider-text slider-text--complex">
                {{ __('Рад Вас приветствовать из солнечной Аланьи. Уже более 6-ти лет наша компания занимается строительством и продажей недвижимости на территории Аланьи. Нашей основной задачей является профессиональная консультация и помощь при выборе и покупки недвижимости.') }}
            </div>
            <div class="slider-text slider-text--author">{{ __('Основатель компании, г-н Махмуд Шафие') }}</div>
            <div class="slider-text slider-text--ceo">
                ({{ __('CEO Capital Real Estate, CEO Myflat.kz, CEO Capital Investment, CEO Armor Group, Член совета «Офиса прямых инвестиций при президенте Турции»') }})
    ...
    <section class="about-1">
        <div class="max-wrap about-1-wrap">
            <div class="about-1-text">
                <ul>
                    <li>({{ __('Мы даем гарантию лучшей цены') }}</li>
                    <li>({{ __('Отсутствие любых сопутствующих надбавок и прочих скрытых расходов') }} </li>
                    <li>({{ __('Мы не берем риэлтерскую комиссию') }} </li>
                    <li>({{ __('Полностью сопровождаем клиента на всех этапах сделки') }}</li>
                    <li>({{ __('Помогаем с обустройством (с открытием бизнеса, оформлением всех документов и т.д.)') }}
                    </li>
                </ul>
            </div>
    ...
    <section class="about-2-about">
        ...
        <div class="about-2-wrap">
            ...
            {{ __('Наша команда всегда готова ответить на Ваши вопросы.') }} <p>{{ __('Мы всегда на связи') }}!</p>
