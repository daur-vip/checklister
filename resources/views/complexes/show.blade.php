...
@section('content')
    ...
    <section class="about-1">
        <div class="max-wrap about-1-wrap">
            ...
            <div class="about-1-image">
                <img src="/{{ $complex->image2 }}" alt="Complex 2">
            </div>
        </div>
    </section>
    ...
    <section class="about-3">
        <div class="max-wrap about-3-wrap">
            <div class="about-3-item--div">
                <img class="about-3-item--img" src="/{{ $complex->image4 }}" alt="">
            </div>
            <div class="about-3-item--text">
                {!! $complex->{'desc4_' . app()->getLocale()} !!}
            </div>
            <div class="about-3-item--div">
                <img class="about-3-item--img" src="/{{ $complex->image5 }}" alt="">
            </div>
        </div>
        ...
        <div class="max-wrap">
            <div class="about-4-wrap">
                <div class="about-4-left">
                    <img class="about-4-left__img" src="/{{ $complex->image6 }}" alt="">
                </div>
                <div class="about-4-right">
                    <div>
                        <img class="about-4-right__img" src="/{{ $complex->image7 }}" alt="">
                    </div>
                    <div>
                        <img class="about-4-right__img" src="/{{ $complex->image8 }}" alt="">
                    </div>
                    <div>
                        <img class="about-4-right__img" src="/{{ $complex->image9 }}" alt="">
                    </div>
                    <div>
                        <img class="about-4-right__img" src="/{{ $complex->image10 }}" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="about-5">
        <div class="about-5-bg" style="background-image: url(/{{ $complex->image10 }});
           background-size: cover;
           background-repeat: no-repeat;
