    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                @endif
                @if (isset($isSmi))
                    <form action="{{ route('admin.media.update', $news->id) }}" method="POST"
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="seo_desc_ru" name="seo_desc_ru"
                            ...
                            value="{{ old('seo_desc_ru', $news->seo_desc_ru) }}">
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="seo_keywords_ru" name="seo_keywords_ru"
                            ...
                            value="{{ old('seo_keywords_ru', $news->seo_keywords_ru) }}">
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="seo_desc_en" name="seo_desc_en"
                            ...
                            value="{{ old('seo_desc_en', $news->seo_desc_en) }}">
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="seo_keywords_en" name="seo_keywords_en"
                            ...
                            value="{{ old('seo_keywords_en', $news->seo_keywords_en) }}">
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="title_ru" name="title_ru"
                            placeholder=" {{ __('Название новости (рус)') }}"
                            value="{{ old('title_ru', $news->title_ru) }}">
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="title_en" name="title_en"
                            placeholder=" {{ __('Название новости (eng)') }}"
                    ...
                    @if (isset($isSmi))
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="smi_ru" name="smi_ru"
                                placeholder=" {{ __('Название СМИ (eng)') }}"
                                value="{{ old('smi_ru', $news->smi_ru) }}">
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="complex-textarea1" name="desc1_ru"
                            rows="5">{{ old('desc1_ru', $news->desc1_ru) }}</textarea>
                    </div>
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="complex-textarea2" name="desc1_en"
                            rows="5">{{ old('desc1_en', $news->desc1_en) }}</textarea>
                    </div>
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="complex-textarea3" name="desc2_ru"
                            rows="5">{{ old('desc2_ru', $news->desc2_ru) }}</textarea>
                    </div>
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="complex-textarea4" name="desc2_en"
                            rows="5">{{ old('desc2_en', $news->desc2_en) }}</textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="image1_desc_ru" name="image1_desc_ru"
                            placeholder=" {{ __('Описание фото 1 (rus)') }}"
                            value="{{ old('image1_desc_ru', $news->image1_desc_ru) }}">
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="image1_desc_en" name="image1_desc_en"
                            placeholder=" {{ __('Описание фото 1 (eng)') }}"
                            value="{{ old('image1_desc_en', $news->image1_desc_en) }}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="image2_desc_ru" name="image2_desc_ru"
                            placeholder=" {{ __('Описание фото 2 (rus)') }}"
                            value="{{ old('image2_desc_ru', $news->image2_desc_ru) }}">
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="image2_desc_en" name="image2_desc_en"
                            placeholder=" {{ __('Описание фото 2 (eng)') }}"
                            value="{{ old('image2_desc_en', $news->image2_desc_en) }}">
                    </div>
                    <div class="form-group">
