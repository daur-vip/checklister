                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name"
                                placeholder=" {{ __('Название комплекса') }}" value="{{ old('name') }}">
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="area_ru" name="area_ru"
                                placeholder=" {{ __('Название района (рус)') }}" value="{{ old('area_ru') }}">
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="area_en" name="area_en"
                                placeholder=" {{ __('Название района (eng)') }}" value="{{ old('area_en') }}">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="map" name="map" rows="5">{{ old('map') }}</textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="complex-textarea5" name="desc3_ru" rows="5">{{ old('desc3_ru') }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label for="desc3_en" class="form-label">
                                {{ __('Описание 3 на английском') }}
                            </label>
                            <textarea class="form-control" id="complex-textarea6" name="desc3_en" rows="5">{{ old('desc3_en') }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label for="description" class="form-label">
                                {{ __('Описание 4 на русском') }}
                            </label>
                            <textarea class="form-control" id="complex-textarea7" name="desc4_ru" rows="5">{{ old('desc4_ru') }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label for="description" class="form-label">
                                {{ __('Описание 4 на английском') }}
                            </label>
                            <textarea class="form-control" id="complex-textarea8" name="desc4_en" rows="5">{{ old('desc4_en') }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label for="description" class="form-label">
                                {{ __('Описание 5 на русском') }}
                            </label>
                            <textarea class="form-control" id="complex-textarea9" name="desc5_ru" rows="5">{{ old('desc5_ru') }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label for="description" class="form-label">
                                {{ __('Описание 5 на английском') }}
                            </label>
                            <textarea class="form-control" id="complex-textarea10" name="desc5_en" rows="5">{{ old('desc5_en') }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label for="description" class="form-label">
                                {{ __('Описание 6 на русском') }}
                            </label>
                            <textarea class="form-control" id="complex-textarea11" name="desc6_ru" rows="5">{{ old('desc6_ru') }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label for="description" class="form-label">
                                {{ __('Описание 6 на английском') }}
                            </label>
                            <textarea class="form-control" id="complex-textarea12" name="desc6_en" rows="5">{{ old('desc6_en') }}</textarea>
                        </div>
